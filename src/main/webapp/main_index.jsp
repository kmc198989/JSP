...
<td>결제수단</td>
<td>
<input type="radio" name="payment" value="0" checked>카드
<input type="radio" name="payment" value="1" >현금
<input type="radio" name="payment" value="2" >계좌이체</td>
</tr>
...
<tr>
<td colspan="2">
<input type="submit" value="등록"  href="login.do">
